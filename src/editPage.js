...
function collectFormData() {
    ...
    return {
        ...
        num_primary_loads_60T: document.querySelector("input[placeholder='Enter details for 60 Ton']").value,
        num_primary_loads_70T: document.querySelector("input[placeholder='Enter details for 70 Ton']").value,
        primary_crushed_tons: document.querySelector("input[placeholder='Tons crushed Primary']").value,
        dry_plt_crushed_tons: document.querySelector("input[placeholder='Tons crushed Dry Plant']").value,
