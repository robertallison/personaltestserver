...
function collectFormData() {
    ...
    return {
        ...
        num_primary_loads_35T: parseInt(document.getElementById("numPrimaryLoads35TInput").text),
        num_primary_loads_40T: parseInt(document.getElementById("numPrimaryLoads40TInput").text),
        num_primary_loads_50T: parseInt(document.getElementById("numPrimaryLoads50TInput").text),
        num_primary_loads_60T: parseInt(document.getElementById("numPrimaryLoads60TInput").text),
        num_primary_loads_70T: parseInt(document.getElementById("numPrimaryLoads70TInput").text),
        primary_crushed_tons: parseInt(document.getElementById("primaryCrushedTonsInput").text),
        dry_plt_produced_tons: parseInt(document.getElementById("dryPltProducedTonsInput").text),
        dry_plt_scheduled_hrs: parseFloat(document.getElementById("dryPltScheduledHrsInput").text),
        ...
        dry_plt_nonop_downtime_comments: document.getElementById("dryPltNonOpDowntimeCommentsInput").text,
        ...
        primary_addtl_details: document.getElementById("primaryAddtlDetailsInput").text,
        ...
        primary_addtl_details_2: document.getElementById("primaryAddtlDetails2Input").text,
        ...
        wet_plt_nonop_downtime_comments: document.getElementById("wetPltNonOpDowntimeCommentsInput").text,
        ...
        secondary_addtl_details: document.getElementById("secondaryAddtlDetailsInput").text,
